...
namespace Lab3_CG
{
    public partial class Form1 : Form
    {
        ...
        private enum Mode { Drawing, Fill1, Fill2, FindBorder }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            if (pictureBox1.Image == null || (currentMode != Mode.Fill1 && currentMode != Mode.Fill2 && currentMode != Mode.FindBorder))
                return;

            if (currentMode == Mode.Fill1)
                FillArea(clickedPoint.X, clickedPoint.Y);
            else if (currentMode == Mode.Fill2 && pictureBox2.Image != null)
                FillAreaWithPictures(clickedPoint.X, clickedPoint.Y);
            else if (currentMode == Mode.FindBorder)
                FindBorder();
