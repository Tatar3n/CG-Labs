...
int main()
{
    ...
    sf::RenderWindow window(sf::VideoMode({ 1000, 800 }), "Lab_14");
    ...
    models.push_back(Model("resources/obj3/bonnie/bonnie.obj"));
    models.push_back(Model("resources/obj3/springbonnie/Fnaf.obj"));
    models.push_back(Model("resources/obj3/Freddy/Freddy.obj"));
    models.push_back(Model("resources/obj3/balloonboy/balloonboy.obj"));
    models.push_back(Model("resources/obj3/chica/chica.obj"));
